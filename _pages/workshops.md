...
/\*
_ When the customer clicks on the button, redirect
_ them to Checkout.
_/
...
mode: 'payment',
/_
_ Do not rely on the redirect to the successUrl for fulfilling
_ purchases, customers may not always reach the success_url after
_ a successful payment.
_ Instead use one of the strategies described in
_ https://docs.stripe.com/payments/checkout/fulfill-orders
_/
...
if (result.error) {
/\*
_ If `redirectToCheckout` fails due to a browser or network
_ error, display the localized error message to your customer.
\*/
